...
import { usePostHeaderDashboard } from "../../hooks/useDashboard"
import {
  TypeDashboardHeader,
  TypeFiltroRelatorio,
    ...
    <div className="bg-primary/90 rounded-t-[var(--radius)] font-sans">
      <CardHeader className="flex flex-row items-center justify-between p-0 pb-1">
        ...
        <div className="flex flex-row flex-wrap items-end gap-4 text-sm">
          ...
          {/* Data Inicial */}
          <div className="flex flex-col ">
            <Label className="text-white text-xs font-semibold">Data Inicial</Label>
            <div className="flex items-center gap-4">
              <Input
          ...
          {/* Data Final */}
          <div className="flex flex-col ">
            <Label className="text-white text-xs font-semibold">Data Final</Label>
            <div className="flex items-center gap-4">
              <Input
                value={endDateInput}
